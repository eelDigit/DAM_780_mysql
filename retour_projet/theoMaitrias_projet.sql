...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 08 fév. 2023 à 16:07
...
(4, 'Plein Air', '20 rue du Ciel, 66666 Paradis');
...
--
-- Structure de la table `livres_auteur`
--
...
--
-- Déchargement des données de la table `livres_auteur`
--

INSERT INTO `livres_auteur` (`auid`, `isbn`) VALUES
(2, 744),
(4, 744),
(1, 547),
(1, 548),
...
--
ALTER TABLE `livres`
  ADD CONSTRAINT `fk_edid` FOREIGN KEY (`edid`) REFERENCES `editeurs` (`edid`);
